...
<head>
    ...
    <title>BFI HRIS | <?= $data['title'] ?></title>
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li
                      	...
                      	<?php if($_SESSION['userInfo']['dept_name'] == 'HR/GA' || $_SESSION['userInfo']['dept_name'] == 'System' || $_SESSION['userInfo']['dept_name'] == 'Factory Manager' || $_SESSION['userInfo']['dept_name'] == 'General Manager') : ?>
                          <li
                              class="sidebar-item <?= $data['title'] == 'Visitor Log' ? 'active' : ''; ?>">
                            <a href="<?= BASEURL; ?>/guest/log" class='sidebar-link'>
